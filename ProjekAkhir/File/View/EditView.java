...
public class EditView extends JFrame implements ActionListener{
    ...
    JLabel lTitle = new JLabel("EDIT KARYAWAN");
    ...
    public EditView(int id, String nama, int usia, int gaji){
        this.id = id;
        tfNama.setText(nama);
        tfUsia.setText(Integer.toString(usia));
        tfGaji.setText(Integer.toString(usia));
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == btnSimpan){
            controller.simpan(this, this.id);
        }
